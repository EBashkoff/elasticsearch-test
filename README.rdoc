...
The master branch is an implementation of a test database with 100 records in Rails and a search has been implemented on the index page using the deprecated Tire gem
...
To run the prototype on the newlib branch do the following from directory elasticsearch-test:
    ...
    5. Go to localhost:3000/people in the browser
